...
extern struct ir77_ambe_decoder *ir77_ambe_decode_alloc(void);
extern void ir77_ambe_decode_release(struct ir77_ambe_decoder *dec);
extern int  ir77_ambe_decode_superframe(struct ir77_ambe_decoder *dec,
                                 int16_t *audio, int N,
